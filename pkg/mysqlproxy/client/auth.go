...
import (
	...
	"github.com/ztalab/ZASentinel-MYSQL/pkg/mysqlproxy/packet"
...
func (c *Conn) readInitialHandshake() error {
	...
	// If SSL authentication is enabled on the client but not supported by mysql on the server, an error is reported
